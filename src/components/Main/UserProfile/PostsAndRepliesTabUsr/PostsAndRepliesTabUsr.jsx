...
function PostsAndRepliesTabUsr({ postsAndReplies, username, handleSetModalActive }) {
    ...
    <div className="postsAndReplies fadein">
      {postsAndReplies?.length <= 0 && (
        <div className="empty">
          ...
          <h4> empty...</h4>
          <h5> all of {username}&apos;s recent replies will show up here</h5>
        </div>
      )}
...
export default PostsAndRepliesTabUsr;

PostsAndRepliesTabUsr.propTypes = {
