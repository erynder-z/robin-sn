...
function LikesTabUsr({ usrLikes, username, handleSetModalActive }) {
    ...
    <div className="likes fadein">
      {usrLikes.length <= 0 && (
        <div className="empty">
          ...
          <h4> empty...</h4>
          <h5> all recent posts {username} liked will show up here</h5>
        </div>
      )}
      {usrLikes &&
        usrLikes.map((post) => (
...
export default LikesTabUsr;

LikesTabUsr.propTypes = {
